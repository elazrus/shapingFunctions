...
public class BezierFunctionContainer {
	...
	public float function_cubicBezierThrough2Points(float x, float a, float b, float c, float d, boolean clamp) {
		CubicBezierThrough2Points cubicBezierThrough2Points = new CubicBezierThrough2Points(a, b, c, d);
		return cubicBezierThrough2Points.applyFunction(x, clamp);
	}

	public float funciton_cubicBezierThrough2Points(float x, float a, float b, float c, float d) {
		CubicBezierThrough2Points cubicBezierThrough2Points = new CubicBezierThrough2Points(a, b, c, d);
	...
	public float function_doubleQuadraticBezier(float x, float a, float b, float c, float d, boolean clamp) {
		DoubleQuadraticBezier doubleQuadraticBezier = new DoubleQuadraticBezier(a, b, c, d);
